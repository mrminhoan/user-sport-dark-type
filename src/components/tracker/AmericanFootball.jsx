...
const AmericanFootball = ({ fixtureId }) => {
  useEffect(() => {
    if (fixtureId) {
      ...
      script.innerHTML = `
        !(function(){
          ...
          window.STATSCOREWidgets.onLoad(function(e){
            ...
            new window.STATSCOREWidgets.Widget(document.getElementById("STATSCOREWidget17135898724143"),
            "66234e314c6a5387703a7332",
  ...
  return (
    <div
      id="STATSCOREWidget17135898724143"
